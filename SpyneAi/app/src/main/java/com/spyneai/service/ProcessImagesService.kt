...
class ProcessImagesService : Service() {
    ...
    override fun onTaskRemoved(rootIntent: Intent) {
        val restartServiceIntent = Intent(applicationContext, ProcessImagesService::class.java).also {
    ...
    private fun createNotification(): Notification {
        ...
        val pendingIntent: PendingIntent = Intent(this, DashboardActivity::class.java).let { notificationIntent ->
