...
class ShowImagesDemoActivity : AppCompatActivity() {
...
//        setBulkImages()
    ...
    private fun setListeners() {
        ...
        ivHomeShowImages.setOnClickListener(View.OnClickListener {
            Utilities.savePrefrence(this@ShowImagesDemoActivity, AppConstants.SHOOT_ID, "")
            Utilities.savePrefrence(this@ShowImagesDemoActivity, AppConstants.CATEGORY_ID, "")
            Utilities.savePrefrence(this@ShowImagesDemoActivity, AppConstants.PRODUCT_ID, "")
            Utilities.savePrefrence(this@ShowImagesDemoActivity, AppConstants.SKU_NAME, "")
            Utilities.savePrefrence(this@ShowImagesDemoActivity, AppConstants.SKU_ID, "")
...
//                Utilities.hideProgressDialog()
//                Toast.makeText(this@ShowImagesDemoActivity,
