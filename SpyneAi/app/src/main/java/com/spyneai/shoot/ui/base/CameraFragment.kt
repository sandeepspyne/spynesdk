...
//            })
       ...
       //camera setting
        ...
        binding.switchShowGyro?.setOnCheckedChangeListener { _, isChecked ->
                Utilities.saveBool(requireContext(), viewModel.categoryDetails.value?.categoryId+AppConstants.SETTING_STATUS_GYRO, isChecked)
                if (isChecked)
        ...
        binding.switchShowOverlay?.setOnCheckedChangeListener { _, isChecked ->
            Utilities.saveBool(requireContext(), viewModel.categoryDetails.value?.categoryId+AppConstants.SETTING_STATUS_OVERLAY, isChecked)
            if (isChecked)
        ...
        binding.switchShowGrid?.setOnCheckedChangeListener { _, isChecked ->
            Utilities.saveBool(requireContext(), viewModel.categoryDetails.value?.categoryId+AppConstants.SETTING_STATUS_GRID, isChecked)
            if (isChecked)
